...
loader = FNOData(nx= data_config.nx,
                 ny=data_config.ny,
                 dt=data_config.dt,
                 dim=config.dim,
...
print(f'Train state shape: {train_state.shape}') # [time, samples, 4, nx, ny]
...
if data_config.subdomain_process:
  print(f'Splitting data into {domain_config.ndomain_x} subdomains along x and {domain_config.ndomain_y} sub-domains along y')
