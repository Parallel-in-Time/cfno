...
class RBCDataset2D(Dataset):
    def __init__(self, task="training", nf=0, samples = 250, start_t = 0, end_t = 10, sx = 256, sz = 64):
        ...
        base_dir = "/p/scratch/cexalab/john2/RayleighBenardConvection/RBC2D_NX64_NZ64_T025_TF26_Pr1_Ra10e5_dt2_10e_5_fine"
        # Data file: 
        if task == "training":
            self.file_data = f"{base_dir}/RBC2D_NX64_NZ64_T025_TF26_Pr1_Ra10e5_dt2_10e_5_fine_train.h5"
            self.length = samples
        elif task == "validation":
            self.file_data = f"{base_dir}/RBC2D_NX64_NZ64_T025_TF26_Pr1_Ra10e5_dt2_10e_5_fine_val.h5"
            self.length = samples
        elif task == "test":
            self.file_data = f"{base_dir}/RBC2D_NX64_NZ64_T025_TF26_Pr1_Ra10e5_dt2_10e_5_fine_test.h5"
            self.length = samples
        else:
